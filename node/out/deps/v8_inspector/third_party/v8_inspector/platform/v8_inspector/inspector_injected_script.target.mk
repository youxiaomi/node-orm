...
quiet_cmd__home_squid_study_myapp_node_deps_v8_inspector_third_party_v8_inspector_platform_v8_inspector_v8_inspector_gyp_inspector_injected_script_target_ConvertFileToHeaderWithCharacterArray = ACTION _home_squid_study_myapp_node_deps_v8_inspector_third_party_v8_inspector_platform_v8_inspector_v8_inspector_gyp_inspector_injected_script_target_ConvertFileToHeaderWithCharacterArray $@
cmd__home_squid_study_myapp_node_deps_v8_inspector_third_party_v8_inspector_platform_v8_inspector_v8_inspector_gyp_inspector_injected_script_target_ConvertFileToHeaderWithCharacterArray = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/deps/v8_inspector/third_party/v8_inspector/platform/v8_inspector; mkdir -p $(obj)/gen/blink/platform/v8_inspector; python build/xxd.py InjectedScriptSource_js InjectedScriptSource.js "$(obj)/gen/blink/platform/v8_inspector/InjectedScriptSource.h"
...
$(obj)/gen/blink/platform/v8_inspector/InjectedScriptSource.h: $(srcdir)/deps/v8_inspector/third_party/v8_inspector/platform/v8_inspector/build/xxd.py $(srcdir)/deps/v8_inspector/third_party/v8_inspector/platform/v8_inspector/InjectedScriptSource.js FORCE_DO_CMD
	$(call do_cmd,_home_squid_study_myapp_node_deps_v8_inspector_third_party_v8_inspector_platform_v8_inspector_v8_inspector_gyp_inspector_injected_script_target_ConvertFileToHeaderWithCharacterArray)

all_deps += $(obj)/gen/blink/platform/v8_inspector/InjectedScriptSource.h
action__home_squid_study_myapp_node_deps_v8_inspector_third_party_v8_inspector_platform_v8_inspector_v8_inspector_gyp_inspector_injected_script_target_ConvertFileToHeaderWithCharacterArray_outputs := $(obj)/gen/blink/platform/v8_inspector/InjectedScriptSource.h


### Rules for final target.
# Build our special outputs first.
$(obj).target/deps/v8_inspector/third_party/v8_inspector/platform/v8_inspector/inspector_injected_script.stamp: | $(action__home_squid_study_myapp_node_deps_v8_inspector_third_party_v8_inspector_platform_v8_inspector_v8_inspector_gyp_inspector_injected_script_target_ConvertFileToHeaderWithCharacterArray_outputs)

# Preserve order dependency of special output on deps.
$(action__home_squid_study_myapp_node_deps_v8_inspector_third_party_v8_inspector_platform_v8_inspector_v8_inspector_gyp_inspector_injected_script_target_ConvertFileToHeaderWithCharacterArray_outputs): | 
